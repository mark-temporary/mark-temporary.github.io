/**
 * Complete ISO 3166 country list for shipping selection in cart drawers.
 * Source: https://www.iban.com/country-codes
 *
 * Edit SHIPPING_COUNTRIES to restrict which countries appear in the dropdown.
 * The code values must match Stripe's allowed_countries list.
 */
